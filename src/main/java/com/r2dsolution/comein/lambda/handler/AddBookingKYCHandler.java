...
public class AddBookingKYCHandler extends BaseGateWayHandler<AddBookingKYCConfig,GateWayRequest>{
	
	@Override
	protected Class<AddBookingKYCConfig> initGateWayConfig() {
		return AddBookingKYCConfig.class;
	}
